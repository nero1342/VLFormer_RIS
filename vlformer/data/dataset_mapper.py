...
class YTVISDatasetMapper:
    ...
    def __call__(self, dataset_dict):
        ...
        if "length" in dataset_dict: # Video dataset
            ...
            imageType = True
            file_names = [dataset_dict.pop("file_name", None)]
            dataset_dict["length"] = video_length = 1
            dataset_dict["video_name"] = str(dataset_dict["id"])
            dataset_dict["video_id"] = str(dataset_dict["id"])
