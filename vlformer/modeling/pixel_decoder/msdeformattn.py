...
from ..attention import VisionLanguageFusionModule, _get_clones, _get_activation_fn
...
class MSDeformAttnPixelDecoder(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        for idx in range(len(self.transformer_in_features)):
            fusion_module = VisionLanguageFusionModule(conv_dim, nhead=8)
        ...
        #     stage = int(idx + 1)
        #     self.add_module("fusion_fpn_{}".format(stage), fusion_module)
        #     fusion_fpn_modules.append(fusion_module)
    ...
    def forward_features(self, features, caption):
        ...
        for idx, f in enumerate(self.transformer_in_features[::-1]):
            ...
            src_proj_l = self.fusion_modules[idx](tgt=src_proj_l,
        ...
        for idx, f in enumerate(self.in_features[:self.num_fpn_levels][::-1]):
            ...
            # fusion = self.fusion_fpn_modules[idx]
            # cur_fpn = fusion(tgt=cur_fpn,
            #                     memory=text_word_features.float(),
            #                     memory_key_padding_mask=text_word_masks.float(),
            #                     pos=text_pos.float(),
            #                     query_pos=None
